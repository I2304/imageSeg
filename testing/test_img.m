    ...
    % Noise added to same images    
        ...
        if i == 1
            rho_dense = .01*ones(1000); % Two squares. 
                ...
                % Add noise
                noise_idx_1 = add_noise(200,400,200,400,intensity,size(rho_dense));
                rho_dense(noise_idx_1) = rand(size(noise_idx_1));
                noise_idx_2 = (add_noise(500,600,500,600,intensity,size(rho_dense)));
                rho_dense(noise_idx_2) = rand(size(noise_idx_2));
        ...
        elseif i == 2
            ...
            rho_dense(200:800, 200:800) = 1; 
            noise_idx = (add_noise(200,800,200,800,intensity,size(rho_dense)));
            rho_dense(noise_idx) = rand(size(noise_idx));
            rho_truth(200:800, 200:800) = 2; 

            rho_dense(300:700, 300:700) = .01;
            noise_idx = (add_noise(300,700,300,700,intensity,size(rho_dense)));
            rho_dense(noise_idx) = rand(size(noise_idx));
            rho_truth(300:700, 300:700) = 1;

            rho_dense(400:600, 400:600) = 1;
            noise_idx = (add_noise(400,600,400,600,intensity,size(rho_dense)));
            rho_dense(noise_idx) = rand(size(noise_idx));
            rho_truth(400:600, 400:600) = 3;

            rho_dense(600:800, 100:150) = 1;
            noise_idx = (add_noise(600,800,100,150,intensity,size(rho_dense)));
            rho_dense(noise_idx) = rand(size(noise_idx));
            rho_truth(600:800, 100:150) = 4;

            rho_dense(650:750, 110:140) = .01;
            noise_idx = (add_noise(650,750,110,140,intensity,size(rho_dense)));
            rho_dense(noise_idx) = rand(size(noise_idx));
            rho_truth(650:750, 110:140) = 1;
        ...
        elseif i == 3
            ...
            rho_truth = ones(1000); 
                ...
                rho_dense(150:350, 150:350) = .01; 
                noise_idx = (add_noise(150,350,150,350,intensity,size(rho_dense)));
                rho_dense(noise_idx) = rand(size(noise_idx));
                rho_truth(150:350, 150:350) = 1; 
                
                rho_dense(150:400, 200:230) = 1; 
                noise_idx = (add_noise(150,400,200,230,intensity,size(rho_dense)));
                rho_dense(noise_idx) = rand(size(noise_idx));
                rho_truth(150:400, 200:230) = 2; 
                
                rho_dense(275:325, 275:325) = 1; 
                noise_idx = (add_noise(275,325,275,325,intensity,size(rho_dense)));
                rho_dense(noise_idx) = rand(size(noise_idx));
                rho_truth(275:325, 275:325) = 8; 
                
                rho_dense(200:225, 275:300) = 1; 
                noise_idx = (add_noise(200,225,275,300,intensity,size(rho_dense)));
                rho_dense(noise_idx) = rand(size(noise_idx));
                rho_truth(200:225, 275:300) = 9; 
                
                rho_dense(800:900, 100:200) = 1; 
                noise_idx = (add_noise(800,900,100,200,intensity,size(rho_dense)));
                rho_dense(noise_idx) = rand(size(noise_idx));
                rho_truth(800:900, 100:200) = 10;
                num_clusters = 10; 
        end
        if i == 4
            ...
            rho_dense(50:150, 50:150) = 1;
            noise_idx = (add_noise(50,150,50,150,intensity,size(rho_dense)));
            rho_dense(noise_idx) = rand(size(noise_idx));
            rho_truth(50:150, 50:150) = 7;
            
            rho_dense(175:275, 175:275) = 1;
            noise_idx  = (add_noise(175,275,175,275,intensity,size(rho_dense)));
            rho_dense(noise_idx) = rand(size(noise_idx));
            rho_truth(175:275, 175:275) = 8;
